module.exports = {
    ...
    async execute(message, args) {
        let mention = message.mentions.members.first()
				if (!mention) return message.channel.send("Either you didn't mention a person or you got the command syntax wrong, the command is `%riddy @person` you silly sausage") 
				let images = {
